...
-------------------------------------
 ...
 INSTALACION
	...
	PASO 1
		...
		- Primero ubicarse en la carpeta que contiene el archivo "requeriments.txt"
		$ pip install -r requeriments.txt

	PASO 2
		--- INICIAR SERVIDOR ---
		- Primero ubicarse en la carpeta que contiene el manage.py > [C:..\entorno\pre_entrega_n3]
